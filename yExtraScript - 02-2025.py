...
QtBind.createLabel(gui,'<- This Page Explain command possible in script ->',210,11)
QtBind.createLabel(gui,' - SetScript,SCRIPTNAME.txt : change script, script must be in PHbot folder \n                               & char must be in town when change script\n\n - LeaveParty : use to leave party\n\n - StartTrace,PLAYERNAME : Starts tracing a player\n\n - RemoveSkill,SKILLNAME : Removes the skill/buff if active\n\n - GoClientless : Kills the Client instantly\n\n - StartBot,in,X : Stops then Starts bot in X minutes\n - StartBot,at,00:00 : Starts bot at specified time (24H)\n\n - CloseBot,in,X : kills the bot in X amount of minutes\n - CloseBot,at,00:00 kills the bot at a specific time (24H)\n\n - PlaySound,ding.wav : play sound, file must be in your PHbot folder,',35,45)
