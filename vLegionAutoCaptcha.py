...
lblInfo = QtBind.createLabel(gui,
                             'Welcome to vLegionAutoCaptcha plugin, it\'s a simple plugin to resolve the captcha everytime it appears.\n' +
...
# centralized logger
def xlog(message):
    log('Plugin (vLegionAutoCaptcha): ' + message)
